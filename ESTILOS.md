...
### 🔵 Futurista & Tech (66 estilos)

Estilos futuristas, sci-fi, cyberpunk e interfaces tecnológicas:
...
| 171 | Hacker Aesthetic CRT/CLI | `hacker-aesthetic-crtcli` |
...
| 257 | Aura Premium WebGL & Iconify | `aura-premium-webgl-iconify` |
| 266 | Neon Cyber | `neon-cyber` |
| 267 | Terminal Green | `terminal-green` |
| 290 | Aurora | `aurora` |
| 312 | Cyber Core | `cyber-core` |
| 319 | Gothic | `gothic` |
...
| 280 | Mini World | `mini-world` |
| 281 | Chalkboard | `chalkboard` |
| 285 | Whiteboard | `whiteboard` |
| 286 | Kawaii Doodle Art | `kawaii-doodle-art` |
| 288 | Neoclassical Art | `neoclassical-art` |
| 289 | Baroque | `baroque` |
| 291 | Ethereal | `ethereal` |
| 292 | Filigree | `filigree` |
| 293 | Acanthus | `acanthus` |
| 294 | Anthropomorphic | `anthropomorphic` |
| 296 | Conceptual Sketch / Doodle Art | `conceptual-sketch-doodle-art` |
| 300 | Bohemian (Boho) | `bohemian-boho` |
| 302 | Farmhouse / Cottage Core | `farmhouse-cottage-core` |
| 303 | Victorian | `victorian` |
| 304 | Art Deco | `art-deco` |
| 305 | Art Nouveau | `art-nouveau` |
| 306 | Mystical Western | `mystical-western` |
| 310 | Bauhaus | `bauhaus` |
| 315 | Pop Art | `pop-art` |
| 317 | Graffiti | `graffiti` |
| 318 | Tenebrism | `tenebrism` |
| 320 | Pointillism / Stipple Art | `pointillism-stipple-art` |
| 321 | Mixed Media | `mixed-media` |
...
Estilos retrô, nostálgicos e de cultura pop:
...
| 282 | Anime Battle | `anime-battle` |
| 284 | 90s Retro Video Game | `90s-retro-video-game` |
| 287 | Resume Journey Oregon Trail | `resume-journey-oregon-trail` |
| 295 | Pixel Art 8-bit | `pixel-art-8-bit` |
| 299 | Memphis | `memphis` |
| 301 | Shabby Chic | `shabby-chic` |
| 307 | Kitsch | `kitsch` |
| 309 | Y2K | `y2k` |
| 313 | Synthwave | `synthwave` |
| 314 | Vaporwave | `vaporwave` |
| 322 | Steampunk | `steampunk` |
| 323 | Kawaii | `kawaii` |
| 327 | Mid-Century Modern | `mid-century-modern` |

### 🟡 Temas & Verticais (36 estilos)

Estilos temáticos para nichos e verticais específicas:
...
| 58 | Biomimetic / Organic 2.0 | `biomimetic-organic-20` |
...
| 258 | Bold Signal | `bold-signal` |
| 259 | Electric Studio | `electric-studio` |
| 260 | Creative Voltage | `creative-voltage` |
| 261 | Dark Botanical | `dark-botanical` |
| 264 | Split Pastel | `split-pastel` |
| 330 | Laranja Queimado Premium | `laranja-queimado-premium` |
| 331 | Caramelo Quente Premium | `caramelo-quente-premium` |
| 332 | Roxo Veludo Real | `roxo-veludo-real` |
| 333 | Midnight Garden Premium | `midnight-garden-premium` |
| 334 | Ember & Amethyst Premium | `ember-amethyst-premium` |
| 335 | Arctic Forsythia Premium | `arctic-forsythia-premium` |

### 📰 Editorial & Tipografia (35 estilos)

Estilos editoriais, tipográficos e de publicação:
...
| 262 | Notebook Tabs | `notebook-tabs` |
| 265 | Vintage Editorial | `vintage-editorial` |
| 269 | Paper & Ink | `paper-ink` |
| 270 | Manrope Typography | `manrope-typography` |
| 271 | Fraunces Typography | `fraunces-typography` |
| 272 | Syne Typography | `syne-typography` |
| 273 | Inter Typography | `inter-typography` |
| 274 | Albert Sans Typography | `albert-sans-typography` |
| 275 | Merriweather Typography | `merriweather-typography` |
| 276 | Tenor Sans Typography | `tenor-sans-typography` |
| 277 | Space Grotesk Typography | `space-grotesk-typography` |
| 278 | Google Sans Typography | `google-sans-typography` |
| 279 | IBM Plex Sans Typography | `ibm-plex-sans-typography` |
| 297 | Luxury Typography | `luxury-typography` |
| 308 | 3x3 Grid Design | `3x3-grid-design` |
| 316 | Bento Grid | `bento-grid` |

### 🔴 Dados & Infografico (24 estilos)

Dashboards, infográficos e visualização de dados:
...
Estilos com identidade visual brasileira:
...
| 239 | Cordel Digital | `cordel-digital` |
| 240 | Bossa Nova Lounge | `bossa-nova-lounge` |
| 241 | Maracatu Tech | `maracatu-tech` |
| 242 | Cerrado Minimalista | `cerrado-minimalista` |
| 243 | Amazônia Futurista | `amazonia-futurista` |
...
### ⚪ Minimalismo & Swiss (20 estilos)

Estilos minimalistas, Swiss Design e grid-based:
...
| 50 | Swiss Modernism 2.0 | `swiss-modernism-20` |
...
| 268 | Swiss Modern | `swiss-modern` |
| 298 | Japandi | `japandi` |
| 326 | Utilitarian | `utilitarian` |

### 🔷 Flat & Soft UI (18 estilos)

Estilos flat design, soft UI e interfaces limpas:
...
| 263 | Pastel Geometry | `pastel-geometry` |
| 283 | Tactile 3D Neumorphism | `tactile-3d-neumorphism` |

### ⚫ Brutalismo (11 estilos)
...
| # | Estilo | Slug |
|---|--------|------|
| 336 | Locomotive Infinite Scroll | `locomotive-infinite-scroll` |
